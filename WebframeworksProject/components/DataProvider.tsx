...
const DataProvider = ({children}: {children: React.ReactNode}) => {
    ...
    const headers = { 'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImhvcGluZy5rZXVuZ0BzdHVkZW50LmFwLmJlIiwiaWF0IjoxNzMzMjQ3NDc2fQ.oQ4JCAGe3JS7VBgJPFQb1vBNE0HPoUhvmdu8ZqU5YmM' };
